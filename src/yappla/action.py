...
class Action:
    ...
    a set of action operators (start, abort, success, failure, aborted) to ease the
    planning process.
    """
    ...
    def __init__(
        ...
        # Optional metadata for actions produced by DurativeActionSpec.split().
        # These fields are intentionally plain strings to keep serialization/simple
        # printing easy.
    ...
    def preconditions(self) -> str:
        ...
        return self._preconditions or "True"
