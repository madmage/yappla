...
def test_entailment():
    ...
    print("robot_valid(r1)?", entails(kb, Predicate("robot_valid", ["r1"])))
    print("robot_valid(r3)?", entails(kb, Predicate("robot_valid", ["r3"])))
    print("alarm(r1)?", entails(kb, Predicate("alarm", ["r1"])))
    print("alarm(r3)?", entails(kb, Predicate("alarm", ["r3"])))
    print("pair_different(r1, r2)?", entails(kb, Predicate("pair_different", ["r1", "r2"])))
    print("pair_different(r1, r1)?", entails(kb, Predicate("pair_different", ["r1", "r1"])))
