...
class KnowledgeBase:
    ...
    - A Fact is a ground atom that is unconditionally true (e.g., "parent(john, mary)")
    ...
    def __init__(self):
        self.facts_by_predicate: Dict[str, List[Atom]] = {}
        self.all_facts: List[Atom] = []
    ...
    def get_facts(self, predicate: Optional[str] = None) -> List[Atom]:
